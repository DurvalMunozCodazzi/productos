...
class CLC_Importer {
    ...
    public static function mapeo_default() {
        return [
            ...
            'samsung tablet' => ['Ordenadores', 'Samsung'],
            'lenovo tablet' => ['Ordenadores', 'Lenovo'],
            'c idea' => ['Ordenadores', 'C Idea'],
            'minnie' => ['Ordenadores', 'Minnie'],
            'xiaomi tablet' => ['Ordenadores', 'Xiaomi'],
            'macbook' => ['Ordenadores', 'Apple MacBook'],
            'acer notebook' => ['Ordenadores', 'Acer'],
            'alienware notebook' => ['Ordenadores', 'Alienware'],
            'asus notebook' => ['Ordenadores', 'Asus'],
            'dell notebook' => ['Ordenadores', 'Dell'],
            'hp notebook' => ['Ordenadores', 'HP'],
            'lenovo notebook' => ['Ordenadores', 'Lenovo'],
            'machreator notebook' => ['Ordenadores', 'Machreator'],
            'msi notebook' => ['Ordenadores', 'MSI'],
