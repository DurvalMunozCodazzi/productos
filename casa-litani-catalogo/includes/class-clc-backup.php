...
class CLC_Backup {
    ...
    public static function render_page() {
        ...
        <div class="wrap">
            ...
            <p>Subí un .json generado con el botón de arriba. Por cada artículo del backup que coincida por título
            con uno que existe hoy, restaura su foto y descripción — no crea artículos nuevos ni toca los que no
            estén en el archivo.</p>
    ...
    public static function descargar_backup() {
        ...
        echo wp_json_encode(['generado' => gmdate('c'), 'articulos' => $items]);
        exit;
    }
